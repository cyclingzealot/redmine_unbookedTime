...
// @include     https://code.credil.org/issues/*
...
var myTimeEntries = 'https://code.credil.org/users/419 #activity > dl:nth-child(2) > dt.time-entry > span:nth-child(1)';
...
$.ajax({
	...
	error: function(jqXHR, textStatus, errorThrown) {
		console.log(new Error().lineNumber + "... ");
		alert('Get my times unsuccesfull');
	}
});
